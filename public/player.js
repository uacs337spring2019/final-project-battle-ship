...
(function(){
    ...
    function getboards(){
        ...
        //fetch turn
        fetch("https://battleship-337.herokuapp.com?mode=turn")
        .then(checkStatus)
        //returned data
        .then(function(responseText){
            //posts returned from service
    ...
    function getvalid(){
        //fetch until valid
        fetch("https://battleship-337.herokuapp.com?mode=status")
        .then(checkStatus)
        //returned data
        .then(function(responseText){
            //posts returned from service
    ...
    function post(inmode){
        ...
        //calls fetch
        fetch("https://battleship-337.herokuapp.com", fetchOptions)
            .then(checkStatus)
            .catch(function(error){
                console.error(error);
        });
